    ...
    <div>
      ...
      <div class="flex flex-col min-h-screen w-screen items-center justify-center bg-gray-100 dark:bg-slate-900 dark:text-white">
        <div class="flex justify-center pb-5">
          <h2 class="font-serif text-xl font-semibold text-gray-700 w-[90%] "><img src={theme == 'dark' ? logo2 : logo} alt="" /></h2>
        </div>
          ...
          <form class="w-full max-w-lg">
            <div class="flex flex-wrap -mx-3 mb-6">
              ...
              <div class="w-full px-3 mb-3">
                ...
                <input class="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-password" type="text" placeholder="Name" />
              </div>
              <div class="w-full px-3 mb-3">
                <label class="block uppercase tracking-wide text-gray-700 dark:text-white text-xs font-bold mb-2" for="grid-password">
                  Email
              ...
              <div className='flex w-[100%] justify-end mt-5'>
                <button className="rounded-md bg-blue-600 text-white p-2">Next 	&gt;</button>
              </div>
            </div>
          </form>
        </div>
